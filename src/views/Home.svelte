    ...
    const sheets = [
        {
            n: "01",
            title: "Cuadernos",
            desc: "Apuntes de cursada — DOM, hooks, React, canvas.",
            href: "/cuadernos",
            external: false,
        },
        {
            n: "02",
            title: "Proyectos",
            desc: "Trabajos personales y colaborativos. (en construcción)",
            href: "/proyectos",
            external: false,
        },
        {
            n: "03",
            title: "Contacto",
            desc: "Para colaboraciones o consultas profesionales.",
